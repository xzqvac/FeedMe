...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Filter_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(30, 4) // "next"

    },
    "Filter\0started\0\0finished\0back\0next"
};
...
void Filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Filter::*)() const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Filter::started)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Filter::staticMetaObject = { {
    ...
    qt_meta_stringdata_Filter.offsetsAndSize,
    qt_meta_data_Filter,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Filter_t
, QtPrivate::TypeAndForceComplete<Filter, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
{
    QMetaObject::activate(const_cast< Filter *>(this), &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Filter::finished()const
{
    QMetaObject::activate(const_cast< Filter *>(this), &staticMetaObject, 1, nullptr);
}
QT_WARNING_POP
